...
> Updated: Milestone 10 (end-to-end demonstrator)
...
| 10 | End-to-end demonstrator + fixtures + docs | Complete (this milestone) |
...
- Operational deployment of `cim_*` migrations against production DBs
